...
function orderIDSearch() { // called with parameter "orderid"

}

function customerIDSearch() { // called with parameter "customerid"
    
}

function addressSearch() { // called with parameter "address"
    
}

function deliveryDateSearch() { // called with parameter "date"
    
}

function repSalesPersonSearch() { // called with parameter "salesperson"
    
}

function productCodeSearch() { // called with parameter "productid"
